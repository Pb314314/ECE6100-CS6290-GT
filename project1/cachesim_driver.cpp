...
//static void pb_print_cache_config(cache_config_t *cache_config, const char *cache_name);
...
int main(int argc, char **argv) {
    ...
    //freopen("./pb_out/out.txt", "a", stdout);
    /*
    char outputFilename[1000];
    snprintf(outputFilename, sizeof(outputFilename), "./pb_out%s.txt", &trace_fn[1]);
    //printf("***************************&*&*&****%s****%s*********",outputFilename,trace_fn);
    freopen(outputFilename, "a", stdout);
    pb_print_cache_config(&config.l1_config, "L1");
    pb_print_cache_config(&config.l2_config, "L2");
    printf("\n");
    */
